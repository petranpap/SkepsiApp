...
{{--            </a>--}}
        ...
        <script>
            $("li:not(#new_intern_menu)").removeClass("bg-gray-100 border-double border-4 border-green-500 text-gray-700 ");
            $("#new_intern_menu").addClass("bg-gray-100 border-double border-4 border-green-500 text-blue-500 ");
