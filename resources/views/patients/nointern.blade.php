@if( Auth::user())
                        ...
                        @foreach ($patients as $patient)
                            @if( Auth::user()->admin ==1)
                                <tr class="bg-white border-b hover:bg-teal-100 hover:text-black dark:border-white-700 text-sm text-black">
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="/patients/edit_no_intern/{{ $patient->id}}"><img src="/icons/edit.png" width="50" class="mx-auto	"></a>
    ...
    <script>
        $("li:not(#no_intern_patients)").removeClass("bg-gray-100 border-double border-4 border-green-500 text-gray-700");
        $("#no_intern_patients").addClass("bg-gray-100 border-double border-4 border-green-500 text-blue-500");
